...
function Rating() {
  return (
    ...
    <div className="lg:p-20 p-10">
      ...
      <div class="grid mb-8 border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 md:mb-12 md:grid-cols-2 dark:bg-gray-800 bg-white">
      ...
      <button class="custom-btn btn-15">Read More</button>
        <button className="custom-btn btn-3">See more Testimonials</button>
      </div>
    </div>
    </>
  );
