  ...
  return (
    <>
      <div className="background" style={{
        ...
        <footer className="relative z-10 pb-10 pt-20 dark:bg-dark lg:pb-20 lg:pt-[120px] p-20">
          <div className="container" style={
            {
              background: "rgba(0,0,0,0.1)", padding: "25px 45px"
            }
          }>
            <div className="-mx-4 flex flex-wrap text-white">
              <div className="w-full px-4 sm:w-2/3 lg:w-3/12 ">
                <div className="mb-10 w-full">
                  ...
                  <p className="mb-7 text-base text-body-color dark:text-dark-6" style={{
                    color: "#3575a9"
                  }}>
                  ...
                  <p className="flex items-center text-sm font-medium text-white dark:text-white">
                    ...
                    <span>+13075290408</span>
                  </p>
                </div>
              </div>
              <LinkGroup header="Newsletter">
                <p className="mb-7 text-base dark:text-dark-6" style={{
                  color: "#fff"
                }}>
                  Subscribe our newsletter to get our latest update & news.</p>
              </LinkGroup>
              ...
              <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
                <div className="mb-10 w-full">
                  ...
                  <p className="text-base text-body-color dark:text-dark-6" style={{
                    color: "#3575a9"
                  }}>
                  </p>
                </div>
